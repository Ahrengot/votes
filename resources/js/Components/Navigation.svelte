                    ...
                    <BreezeDropdown class="w-48 origin-top-right right-0">
                        <span class="inline-flex rounded-md" slot="trigger">
                            <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                                ...
                                <svg class="ml-2 -mr-0.5 w-4 h-4" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                ...
                >
                    <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d={showingNavigationDropdown ? "M6 18L18 6M6 6l12 12" : "M4 6h16M4 12h16M4 18h16"} />
                    </svg>
                </button>
            </div>
        </div>
